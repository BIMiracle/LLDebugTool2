...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        cell.textLabel.text = NSLocalizedString(@"错误请求", nil);
    }
...
- (void)testErrorNetworkRequest{
    NSString *url = @"http://baochen.irzhd.com/Api/order/childAreaInfo1";
